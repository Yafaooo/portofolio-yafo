...
<body class="bg-[#050810] text-slate-300 bg-grid relative overflow-x-hidden">
 ...
 <a href="https://wa.me/6282272463816" target="_blank" class="fixed bottom-8 right-8 z-[60] bg-indigo-600 hover:bg-indigo-500 text-white p-4 rounded-full shadow-lg shadow-indigo-500/20 transition-all hover:scale-110 active:scale-95 group">
 ...
 <span class="absolute right-full mr-4 top-1/2 -translate-y-1/2 bg-slate-800 text-white text-[10px] px-2 py-1 rounded opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap tracking-widest">CHAT YAFAO</span>
 </a>

 <nav class="fixed w-full top-0 z-50 bg-[#050810]/80 backdrop-blur-xl border-b border-white/5">
...
Mentransformasi logika kompleks menjadi sistem yang elegan. Spesialisasi dalam pembangunan arsitektur backend yang <span class="text-white">scalable</span> dan <span class="text-white">secure</span>.
</p>
...
<section id="about" class="py-32 px-8 bg-black/20">
 ...
 <p class="text-indigo-400 font-bold mb-6 tracking-wide">SMAK Kasih Karunia & SMP Swasta Teladan Medan</p>
 ...
 <div class="grid md:grid-cols-3 gap-8 border-t border-white/5 pt-12">
 <div class="text-slate-500 font-mono text-sm tracking-widest italic">Implementation</div>
 <div class="md:col-span-2">
 <h4 class="text-2xl font-bold text-white mb-8 uppercase tracking-tighter">Sistem Informasi Pengolahan Data</h4>
 
 <div class="grid md:grid-cols-2 gap-8">
 <div class="bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-indigo-500/50 transition-all group">
 ...
 <span class="text-white text-[10px] font-bold tracking-widest opacity-0 group-hover:opacity-100 transition-all transform translate-y-4 group-hover:translate-y-0">VIEW INTERFACE</span>
 </div>
 <img src="{{ asset('images/screenshot-siakad.png') }}" 
 alt="SIAKAD SMAK Kasih Karunia" 
 class="w-full h-full object-cover transform group-hover:scale-110 transition duration-700 opacity-60 group-hover:opacity-100">
 </div>

 <h5 class="text-white font-bold mb-3 group-hover:text-indigo-400 text-lg tracking-tight">SIAKAD (Akademik)</h5>
 <p class="text-[11px] text-slate-400 mb-6 leading-relaxed">
 Sistem informasi akademik terpadu untuk **SMAK Kasih Karunia & SMP Teladan Medan**. Mengelola pendataan murid, jadwal pelajaran, hingga otomatisasi pengolahan nilai raport.
 </p>
 
 <div class="flex items-center justify-between mt-auto">
 <div class="flex items-center gap-4">
 <a href="https://alamat-web-sekolah-anda.com" target="_blank" class="text-[9px] px-4 py-2 bg-indigo-600 text-white rounded-lg font-bold hover:bg-indigo-500 transition shadow-lg shadow-indigo-600/20 flex items-center gap-2 uppercase tracking-widest">
 <span>Live Demo</span>
 ...
 <img src="{{ asset('images/screenshot-gereja.png') }}" 
 alt="Database Jemaat Gereja" 
 class="w-full h-full object-cover transform group-hover:scale-110 transition duration-700 opacity-60 group-hover:opacity-100">
 </div>

 <h5 class="text-white font-bold mb-3 group-hover:text-indigo-400 text-lg tracking-tight">Database Jemaat</h5>
 <p class="text-[11px] text-slate-400 mb-6 leading-relaxed">
 Sistem informasi manajemen data jemaat yang berfokus pada enkripsi data dan akurasi informasi. Memudahkan pengelola dalam pemetaan jemaat dan pelaporan kegiatan secara *real-time*.
 </p>
 
 <div class="flex items-center justify-between mt-auto">
 <div class="flex items-center gap-4">
 <a href="https://alamat-web-gereja-anda.com" target="_blank" class="text-[9px] px-4 py-2 bg-indigo-600 text-white rounded-lg font-bold hover:bg-indigo-500 transition shadow-lg shadow-indigo-600/20 flex items-center gap-2 uppercase tracking-widest">
 <span>Live Demo</span>
 <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" /></svg>
 </a>
 </div>
 ...
 <div class="max-w-6xl mx-auto">
 <h3 class="text-indigo-500 font-mono text-xs mb-16 uppercase tracking-[0.5em]">// Recent Deployments</h3>
 <div class="grid md:grid-cols-2 gap-8">
 <div class="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-transparent hover:from-indigo-500/40 transition-all">
 <div class="bg-[#0b0f1a] p-8 rounded-2xl h-full">
 <span class="text-[10px] text-indigo-400 font-bold uppercase tracking-widest">Enterprise System</span>
 <h4 class="text-2xl font-bold text-white mt-4 mb-4">Stock Management AI</h4>
 <p class="text-sm text-slate-400 mb-8">Optimalisasi rantai pasok dengan efisiensi database tingkat tinggi.</p>
 <a href="#" class="text-xs font-bold text-indigo-400 hover:text-white transition">EXPLORE CODE →</a>
 </div>
 </div>
 <div class="group relative p-1 rounded-2xl bg-gradient-to-b from-white/10 to-transparent hover:from-indigo-500/40 transition-all">
 <div class="bg-[#0b0f1a] p-8 rounded-2xl h-full">
 <span class="text-[10px] text-indigo-400 font-bold uppercase tracking-widest">Security</span>
 <h4 class="text-2xl font-bold text-white mt-4 mb-4">API Gateway Auth</h4>
 <p class="text-sm text-slate-400 mb-8">Infrastruktur microservices dengan keamanan OAuth2 standar global.</p>
 <a href="#" class="text-xs font-bold text-indigo-400 hover:text-white transition">EXPLORE CODE →</a>
 </div>
 </div>
 </div>
 ...
 <div class="max-w-6xl mx-auto">
 <h3 class="text-center text-white text-3xl font-bold mb-20 italic">Modern Stack Expertise</h3>
 <div class="grid grid-cols-2 md:grid-cols-4 gap-6">
 <div class="bg-white/[0.03] border border-white/5 p-8 rounded-2xl text-center hover:border-indigo-500/50 transition">
 <div class="text-indigo-500 text-3xl font-black mb-4">PHP</div>
 <p class="text-[10px] font-bold tracking-widest uppercase text-slate-500">Version 8.4</p>
 </div>
 <div class="bg-white/[0.03] border border-white/5 p-8 rounded-2xl text-center hover:border-indigo-500/50 transition">
 <div class="text-indigo-500 text-3xl font-black mb-4">Go</div>
 <p class="text-[10px] font-bold tracking-widest uppercase text-slate-500">Concurrency</p>
 </div>
 <div class="bg-white/[0.03] border border-white/5 p-8 rounded-2xl text-center hover:border-indigo-500/50 transition">
 <div class="text-indigo-500 text-3xl font-black mb-4">Postgres</div>
 <p class="text-[10px] font-bold tracking-widest uppercase text-slate-500">Relational</p>
 </div>
 <div class="bg-white/[0.03] border border-white/5 p-8 rounded-2xl text-center hover:border-indigo-500/50 transition">
 <div class="text-indigo-500 text-3xl font-black mb-4">Docker</div>
 ...
 <footer class="py-20 text-center bg-black/40">
