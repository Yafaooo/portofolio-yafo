...
<body class="bg-[#050810] text-slate-300 bg-grid relative overflow-x-hidden">
    ...
    <nav data-aos="fade-down" class="fixed w-full top-0 z-50 bg-[#050810]/80 backdrop-blur-xl border-b border-white/5">
        <div class="max-w-6xl mx-auto px-8 py-5 flex justify-between items-center">
            ...
            <div class="hidden md:flex gap-10 text-[10px] uppercase tracking-[0.2em] font-bold">
                ...
                <a href="https://wa.me/6282272463816" class="bg-indigo-600 text-white px-5 py-2 rounded-full hover:bg-indigo-500 transition">Hire Me</a>
            </div>
        </div>
    </nav>
        ...
        <div class="max-w-6xl mx-auto grid md:grid-cols-2 gap-16 items-center">
            <div class="order-2 md:order-1" data-aos="fade-right">
                ...
                <p class="text-lg text-slate-400 mb-10 max-w-lg">
                    Mentransformasi logika kompleks menjadi sistem yang elegan. Spesialisasi Backend Engineer & IT Educator.
                </p>
                <div class="flex gap-6">
                    <div class="flex flex-col"><span class="text-2xl font-bold text-white">S.Kom</span><span class="text-[10px] uppercase text-slate-500">Degree</span></div>
                    <div class="w-[1px] h-10 bg-white/10"></div>
                    <div class="flex flex-col"><span class="text-2xl font-bold text-white">Laravel 12</span><span class="text-[10px] uppercase text-slate-500">Core Stack</span></div>
                </div>
            </div>
            <div class="order-1 md:order-2 flex justify-center" data-aos="zoom-in">
                <div class="relative w-72 h-72 md:w-96 md:h-96 overflow-hidden rounded-full border-2 border-indigo-500/30 p-2 bg-[#050810]">
                    <img src="{{ asset('images/fotosaya.jpeg') }}" alt="Yafao" class="w-full h-full object-cover rounded-full grayscale hover:grayscale-0 transition duration-700">
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="about" class="py-32 px-8 bg-black/20">
        <div class="max-w-6xl mx-auto">
            <div class="flex items-center gap-4 mb-16" data-aos="fade-right">
                <h3 class="text-indigo-500 font-mono text-xs uppercase tracking-[0.3em]">01. Experience</h3>
                <div class="h-[1px] flex-grow bg-white/5"></div>
            </div>
            <div class="grid md:grid-cols-3 gap-8 pt-12" data-aos="fade-up">
                ...
                <div class="md:col-span-2">
                    ...
                    <p class="text-slate-400 leading-relaxed">Mendidik siswa dalam bidang Rekayasa Perangkat Lunak & Pengembangan Solusi Digital.</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="work" class="py-32 px-8">
        <div class="max-w-6xl mx-auto">
            <h3 class="text-indigo-500 font-mono text-xs mb-16 uppercase tracking-[0.5em]" data-aos="fade-right">// Projects Implementation</h3>
            <div class="grid md:grid-cols-2 gap-8">
                <div data-aos="flip-left" class="bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-indigo-500/50 transition-all">
                    <img src="{{ asset('images/screenshot-siakad.png') }}" class="w-full aspect-video object-cover rounded-xl mb-6 opacity-60">
                    <h5 class="text-white font-bold mb-3 text-lg">SIAKAD (Akademik)</h5>
                    <p class="text-xs text-slate-400 mb-6">Sistem Informasi Akademik terintegrasi untuk sekolah.</p>
                    <a href="#" class="inline-block text-[10px] px-4 py-2 bg-indigo-600 text-white rounded-lg font-bold uppercase">Live Demo</a>
                </div>
                <div data-aos="flip-right" class="bg-white/[0.03] p-6 rounded-2xl border border-white/10 hover:border-indigo-500/50 transition-all">
                    <img src="{{ asset('images/screenshot-gereja.png') }}" class="w-full aspect-video object-cover rounded-xl mb-6 opacity-60">
                    <h5 class="text-white font-bold mb-3 text-lg">Database Jemaat</h5>
                    <p class="text-xs text-slate-400 mb-6">Sistem manajemen data jemaat dengan enkripsi SQL.</p>
                    <a href="#" class="inline-block text-[10px] px-4 py-2 bg-indigo-600 text-white rounded-lg font-bold uppercase">Live Demo</a>
                </div>
            </div>
        </div>
    ...
    <div class="fixed bottom-6 right-6 z-50">
        <button onclick="toggleMusic()" id="musicBtn" class="bg-indigo-600/20 backdrop-blur-md border border-white/10 p-4 rounded-full hover:bg-indigo-500 transition-all shadow-2xl">
            <div id="musicIcon" class="text-white">
        ...
        <audio id="bgMusic" loop>
            <source src="https://www.chosic.com/wp-content/uploads/2021/07/Rain-and-Thunder-Sounds.mp3" type="audio/mpeg">
        </audio>
    </div>
    ...
    <script>
        ...
        function toggleMusic() {
            if (music.paused) {
                music.play().then(() => {
                    btn.classList.add('animate-pulse', 'bg-indigo-600');
                }).catch(err => alert("Klik halaman dulu baru tekan musik!"));
            } else {
                music.pause();
                btn.classList.remove('animate-pulse', 'bg-indigo-600');
            }
        }
    </script>
</body>
