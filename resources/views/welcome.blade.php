    ...
    <section id="work" class="py-32 px-8 bg-slate-900/20 border-y border-white/5">
        <div class="max-w-6xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-8">
                ...
                <div data-aos="fade-up" data-aos-delay="200" class="group relative p-1 rounded-3xl bg-gradient-to-b from-white/10 to-transparent hover:from-indigo-500/40 transition-all duration-500">
                    <div class="bg-[#0b0f1a] p-8 rounded-[1.4rem] h-full flex flex-col">
                        <span class="text-[10px] text-indigo-400 font-bold uppercase tracking-widest mb-6">Enterprise System</span>
                        <h4 class="text-2xl font-bold text-white mb-4">Stock Management AI</h4>
                        <p class="text-sm text-slate-400 mb-8 flex-grow">Optimalisasi rantai pasok dengan efisiensi database tingkat tinggi dan arsitektur backend yang kokoh.</p>
                        <a href="#" class="text-xs font-bold text-indigo-400 hover:text-white transition tracking-[0.2em] uppercase">Explore Code →</a>
                    </div>
                </div>
            </div>
        </div>
